...
// Füge eine PopoverText-Komponente hinzu, die BodyText verwendet
const PopoverText = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => <BodyText ref={ref} className={cn(className)} {...props} />,
)
